  ...
  <div class="pozadina">
    <div class="login">
      ...
      <form @submit.prevent="registracija" v-if="i==3">
        <div class="form-group">
          <input v-model="vjestine" type="text" class="form-control" id="exampleInputPassword1" placeholder="Which skills do you have?">
        </div>
        <div class="form-group">
          <input v-model="minimalna_zarada" type="text" class="form-control" id="exampleInputPassword1" placeholder="Minimum hourly rate">
        </div>
        <div class="form-group">
          <input v-model="ostalo" type="text" class="form-control" id="exampleInputPassword1" placeholder="Anything else?">
        </div> 
